...
## [Unreleased]
### Added
- Add the ability to shutdown Fx applications through the Shutdowner interface,
  and provide it to the container.
...
[Unreleased]: https://github.com/uber-go/fx/compare/v1.8.0...HEAD
